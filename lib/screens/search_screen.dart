        ...
        child: Column(
          children: [
            ...
            SearchBox(
              onSumbit: () {
                String search =
                    Get.find<SearchSimpleController>().searchController.text;
                Get.find<SearchSimpleController>().searchController.text = '';
                Get.find<SearchSimpleController>().search(search);
            ...
            Obx(
              (() => Get.find<SearchSimpleController>().isLoading.value
                  ? const CircularProgressIndicator()
                  : Get.find<SearchSimpleController>().foundedMovies.isEmpty
                      ? SizedBox(
                          width: Get.width / 1.5,
                          child: Column(
                            children: [
                      ...
                      : ListView.separated(
                          itemCount:
                              Get.find<SearchSimpleController>().foundedMovies.length,
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          separatorBuilder: (_, __) =>
                              const SizedBox(height: 24),
                          itemBuilder: (_, index) {
                            Movie movie = Get.find<SearchSimpleController>()
                                .foundedMovies[index];
